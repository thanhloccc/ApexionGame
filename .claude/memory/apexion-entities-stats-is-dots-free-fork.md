...
description: Packages/com.apexion.apexion-game/ApexionGame.Entities.Stats is a deliberate DOTS-free fork of EncosyTower.Entities.Stats — never add Unity.Entities to it
metadata:
  type: project
---

`Packages/com.apexion.apexion-game/ApexionGame.Entities.Stats` is a fork of the package's
...
**How to apply:** when stats work comes up, edit the fork under
`Packages/com.apexion.apexion-game/`, not the
