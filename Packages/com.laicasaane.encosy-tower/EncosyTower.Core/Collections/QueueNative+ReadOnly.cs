...
#pragma warning disable IDE1006 // Naming Styles
            ...
            internal readonly unsafe QueueUnsafe<T>* m_Data;
...
#pragma warning restore IDE1006 // Naming Styles
            ...
            internal ReadOnly(QueueNative<T> source)
            {
                // SAFETY: The view borrows the live queue header and owner safety handle.
                unsafe
                {
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static implicit operator ReadOnly(in QueueNative<T> source)
                => source.AsReadOnly();
