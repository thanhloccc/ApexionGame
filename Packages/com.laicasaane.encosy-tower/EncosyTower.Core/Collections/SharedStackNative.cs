...
namespace EncosyTower.Collections
{
    ...
    [NativeContainer]
    public readonly partial struct SharedStackNative<T>
...
#pragma warning restore IDE1006 // Naming Styles
        ...
        internal unsafe SharedStackNative(SharedStackUnsafe<T>* data, AtomicSafetyHandle safety)
        {
...
#else
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        internal unsafe SharedStackNative(SharedStackUnsafe<T>* data)
        {
