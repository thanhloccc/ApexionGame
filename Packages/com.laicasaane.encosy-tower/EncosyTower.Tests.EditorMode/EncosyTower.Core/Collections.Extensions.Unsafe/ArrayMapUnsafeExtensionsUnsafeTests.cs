...
using MapAPI = EncosyTower.Collections.Extensions.Unsafe.ArrayMapUnsafeExtensionsUnsafe;
using MapReadOnlyAPI = EncosyTower.Collections.Extensions.Unsafe.ArrayMapUnsafeReadOnlyExtensionsUnsafe;

namespace EncosyTower.Tests.Core.Collections.Extensions.Unsafe
{
    public partial class ArrayMapUnsafeExtensionsUnsafeTests
    {
        [Test]
