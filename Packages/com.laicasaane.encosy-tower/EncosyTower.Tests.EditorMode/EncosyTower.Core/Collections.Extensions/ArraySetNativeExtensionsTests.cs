...
using SetAPI = EncosyTower.Collections.Extensions.ArraySetNativeExtensions;
using SetReadOnlyAPI = EncosyTower.Collections.Extensions.ArraySetNativeReadOnlyExtensions;

namespace EncosyTower.Tests.Core.Collections.Extensions
{
    public partial class ArraySetNativeExtensionsTests
    {
        [Test]
        ...
        {
            var plainSet = new ArraySetNative<int>(4, Allocator.Temp);
            ...
            var parameterSet = new ArraySetNative<int>(4, Allocator.Temp);
            var parameter = 20;
        ...
        {
            var plainSet = new ArraySetNative<int>(2, Allocator.Temp);
            plainSet.Add(10);
            plainSet.Clear();
            ...
            var parameterSet = new ArraySetNative<int>(2, Allocator.Temp);
            parameterSet.Add(10);
            parameterSet.Clear();
            var parameter = 40;
