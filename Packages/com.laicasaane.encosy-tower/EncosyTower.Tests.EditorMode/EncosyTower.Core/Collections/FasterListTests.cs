...
namespace EncosyTower.Tests.Core.Collections
{
    ...
    {
        [Test]
        public void Constructors_InitializeExpectedContentAndCapacity()
        {
            var empty = new FasterList<int>();
            var withCapacity = new FasterList<int>(8);
            var fromArray = new FasterList<int>(1, 2, 3);
            var segmentSource = new[] { 0, 1, 2, 3, 4 };
            var segment = new ArraySegment<int>(segmentSource, 1, 3);
            var fromSegment = new FasterList<int>(in segment);
            ReadOnlySpan<int> sourceSpan = new[] { 4, 5, 6 };
            var fromSpan = new FasterList<int>(in sourceSpan);
            ICollection<int> sourceCollection = new List<int> { 7, 8, 9 };
            var fromCollection = new FasterList<int>(sourceCollection);
            var withExtra = new FasterList<int>(sourceCollection, 5);
            var fromReadOnly = new FasterList<int>(fromCollection.AsReadOnly());

            Assert.AreEqual(0, empty.Count);
            Assert.AreEqual(0, empty.Capacity);
            Assert.IsFalse(empty.IsReadOnly);
            Assert.AreEqual(0, withCapacity.Count);
            Assert.GreaterOrEqual(withCapacity.Capacity, 8);
            CollectionAssert.AreEqual(new[] { 1, 2, 3 }, fromArray.ToArray());
            CollectionAssert.AreEqual(new[] { 1, 2, 3 }, fromSegment.ToArray());
            CollectionAssert.AreEqual(new[] { 4, 5, 6 }, fromSpan.ToArray());
            CollectionAssert.AreEqual(new[] { 7, 8, 9 }, fromCollection.ToArray());
            CollectionAssert.AreEqual(new[] { 7, 8, 9 }, fromReadOnly.ToArray());
            Assert.AreEqual(3, withExtra.Count);
            Assert.GreaterOrEqual(withExtra.Capacity, 8);
        }
        ...
        {
            var list = new FasterList<int>(10, 20);
        ...
        {
            var list = new FasterList<int>(0, 3, 4);
            var two = 2;
        ...
        {
            var list = new FasterList<int>(1, 2, 2, 3);
            var two = 2;
            var missing = 9;
        ...
        {
            var list = new FasterList<int>(1, 2, 3, 2, 4);
            var two = 2;
            var missing = 9;
        ...
        {
            var list = new FasterList<int>(1, 2, 3, 4, 5, 4);
        ...
        {
            var list = new FasterList<int>(1, 2, 3, 4, 5);
            ...
            var fasterValueResult = new FasterList<int>();
            var fasterInResult = new FasterList<int>();
            var fastValueResult = new ListFast<int>(new List<int>());
            var fastInResult = new ListFast<int>(new List<int>());
            ICollection<int> collectionValueResult = new List<int>();
            ICollection<int> collectionInResult = new List<int>();

            list.FindAll(isOdd, fasterValueResult);
            list.FindAll(isOddIn, fasterInResult);
            list.FindAll(isOdd, fastValueResult);
            list.FindAll(isOddIn, fastInResult);
            ...
            CollectionAssert.AreEqual(new[] { 1, 3, 5 }, fasterValueResult.ToArray());
            CollectionAssert.AreEqual(new[] { 1, 3, 5 }, fasterInResult.ToArray());
            CollectionAssert.AreEqual(new[] { 1, 3, 5 }, fastValueResult.ToArray());
            CollectionAssert.AreEqual(new[] { 1, 3, 5 }, fastInResult.ToArray());
        ...
        {
            var list = new FasterList<int>(0, 0, 0, 0);
        ...
        {
            var list = new FasterList<int>(1, 2, 3, 4);
        ...
        {
            var list = new FasterList<int>(1, 2);
            var three = 3;
        ...
        {
            var defaultSort = new FasterList<int>(4, 1, 3, 2);
            var comparerSort = new FasterList<int>(1, 3, 2, 4);
            var rangeSort = new FasterList<int>(9, 4, 2, 3, 1, 8);
            var comparisonSort = new FasterList<int>(1, 4, 2, 3);
        ...
        {
            var list = new FasterList<int>(1, 2);
            FasterListEnumerator<int> enumerator = list.GetEnumerator();
        ...
        [Test]
        public void ReadOnly_PropertiesViewsConversionsAndCopiesReflectOwner()
        {
            var list = new FasterList<int>(1, 2, 3, 4);
            var constructed = new FasterList<int>.ReadOnly(list);
            var fromMethod = list.AsReadOnly();
            FasterList<int>.ReadOnly converted = list;
            FasterList<int> nullList = null;
            FasterList<int>.ReadOnly empty = nullList;
            ...
            Assert.IsFalse(FasterList<int>.ReadOnly.Empty.IsCreated);
        ...
        {
            var readOnly = new FasterList<int>(1, 2, 3, 4, 5).AsReadOnly();
            Predicate<int> isOdd = value => value % 2 != 0;
            PredicateIn<int> isOddIn = (in int value) => value % 2 != 0;
            var returned = readOnly.FindAll(isOdd);
            var returnedIn = readOnly.FindAll(isOddIn);
            var valueResult = new FasterList<int>();
            var inResult = new FasterList<int>();
            ICollection<int> collectionValueResult = new List<int>();
            ICollection<int> collectionInResult = new List<int>();
        ...
        {
            var readOnly = new FasterList<int>(1, 2).AsReadOnly();
        ...
        {
            var created = 0;
            var fromFactory = FasterList<int>.Prefill(3, () => ++created);
            var defaults = FasterList<int>.Prefill(3);
            var values = FasterList<int>.Prefill(5, 3);
            var noInit = FasterList<int>.PrefillNoInit(3);
