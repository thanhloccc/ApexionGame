...
namespace ApexionGame.SourceGen.Generators.Entities.Stats
{
    ...
    internal sealed class StatDataGenerator : IIncrementalGenerator
    {
        ...
        private const string SKIP_ATTRIBUTE = StatTypeTable.SKIP_ATTRIBUTE;
        ...
        )
        {
            ...
            else if (firstArg.Kind == TypedConstantKind.Type && firstArg.Value is INamedTypeSymbol enumType)
            {
                ...
                if (StatTypeTable.EnumTypeMap.TryGetValue(underlyingType, out var valueTypeName) == false)
                {
                    return default;
                }
            ...
            static void PrintAdditionalUsings(ref Printer p)
            {
                ...
                p.PrintLine("using AGES = global::ApexionGame.Entities.Stats;");
        ...
        private static readonly DiagnosticDescriptor s_errorDescriptor
            = new("AGS_STAT_DATA_UNKNOWN_0001"
