...
namespace EncosyTower.SourceGen.Generators.Persistences
{
    ...
    internal readonly struct PersistAccessorDeclaration
    {
        ...
        public PersistAccessorDeclaration(PersistAccessorSpec info)
        {
    ...
    internal readonly struct ParamDeclaration
    {
        ...
        public static bool TryGetParam(ITypeSymbol type, out ITypeSymbol argType)
        {
            ...
            if (type is INamedTypeSymbol namedType
                && namedType.TryGetGenericType(PERSIST_STORE_BASE, 1, out var baseType)
            ...
            return type.Interfaces.DoesMatchInterface(IPERSIST_ACCESSOR)
                || type.AllInterfaces.DoesMatchInterface(IPERSIST_ACCESSOR);
        }
    }
