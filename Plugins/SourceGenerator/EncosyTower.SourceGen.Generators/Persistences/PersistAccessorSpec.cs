...
namespace EncosyTower.SourceGen.Generators.Persistences
{
    ...
    internal struct PersistAccessorSpec : IEquatable<PersistAccessorSpec>
    {
        ...
        public readonly bool Equals(PersistAccessorSpec other)
        ...
        public readonly override bool Equals(object obj)
            => obj is PersistAccessorSpec other && Equals(other);
