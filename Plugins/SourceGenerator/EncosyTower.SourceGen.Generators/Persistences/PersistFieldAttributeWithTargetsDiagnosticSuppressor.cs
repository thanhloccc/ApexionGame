...
{
    using static EncosyTower.SourceGen.Generators.Persistences.Helpers;
    ...
    public sealed class PersistFieldAttributeWithTargetsDiagnosticSuppressor : DiagnosticSuppressor
    {
        public static readonly SuppressionDescriptor PropertyAttributeListForDataField = new(
              id: "SG_PERSIST_SUPPRESS_0001"
        ...
        public override void ReportSuppressions(SuppressionAnalysisContext context)
        {
            ...
            foreach (Diagnostic diagnostic in context.ReportedDiagnostics)
            {
                ...
                if (declaredSymbol is IFieldSymbol fieldSymbol
                    && fieldSymbol.ContainingType.HasAttribute(PERSIST_ATTRIBUTE, token)
                )
                {
